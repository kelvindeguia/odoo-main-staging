...
class Job(models.Model):
    ...
    # Custom Fields
    requestor_id = fields.Many2one('hr.recruitment.requestor', string="Requestor", related='department_id.requestor_id', store=True)
    department_head_id = fields.Many2one('hr.recruitment.head', string="Department Head", related='department_id.department_head_id', store=True)
