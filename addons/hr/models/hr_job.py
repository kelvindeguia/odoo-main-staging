...
class Job(models.Model):
    ...
    # Custom Fields
    category = fields.Selection([('client_services', 'Client Services'), ('sales_team', 'Sales Team'), ('support_hiring', 'Support Hiring')], string="Category", related='department_id.category', store=True)
