...
class Department(models.Model):
    ...
    # Custom Fields
    job_id = fields.Many2one('hr.job', 'Job Title', store=True)
    category = fields.Selection([('client_services', 'Client Services'), ('sales_team', 'Sales Team'), ('support_hiring', 'Support Hiring')], string="Category", store=True)
